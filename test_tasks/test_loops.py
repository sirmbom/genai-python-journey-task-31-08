...
# 1) number of rows
# TODO: fill this line
rows = len(matrix)  # TODO: replace None with len(matrix)

# 2) number of columns (assume rectangular)
# TODO: fill this line
cols = len(matrix[0])  # TODO: replace None with len(matrix[0])

# 3) initialize flattened list
# TODO: fill this line
flat = []  # TODO: replace None with []
...
for i in range(rows):
    for j in range(cols):
        ...
        flat.append(val)  # TODO: replace None with val

# 5) compute sum of flattened values
# TODO: fill this line
sum_flat = sum(flat)  # TODO: replace None with sum(flat)

# 6) prepare a list of pairs (i,j) for values > 5
# TODO: fill this line
pairs = []  # TODO: replace None with []
for i in range(rows):
    for j in range(cols):
        if matrix[i][j] > 5:
            pairs.append((i, j))
...
average = sum_flat / len(flat)  # TODO: replace None with sum_flat / len(flat)
print("flat:", flat)
