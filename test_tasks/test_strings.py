...
# TODO: fill this line
s_upper = None  # TODO: replace None with s.upper()

# 2) Lowercase version of the string
# TODO: fill this line
s_lower = None  # TODO: replace None with s.lower()

# 3) Does the original string start with two spaces?
# TODO: fill this line
starts_with_two_spaces = None  # TODO: replace None with s.startswith('  ')

# 4) Tokenize into words (split on whitespace)
# TODO: fill this line
words = None  # TODO: replace None with s.split()

# 5) Is the first token purely alphabetic?
# TODO: fill this line
first_is_alpha = None  # TODO: replace None with words[0].isalpha()

# 6) Is there a numeric token (e.g. '123') present and is it numeric?
# TODO: fill this line
numeric_token_is_digit = None  # TODO: replace None with any(tok.isdigit() for tok in words)
...
normalized = None  # TODO: set to ' '.join(s.split()).strip()
